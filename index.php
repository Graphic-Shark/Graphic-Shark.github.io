...
<html lang="en" ng-app="gShark">
  <head>
    ...
    <title>Graphic Shark | HOME</title>
  ...
  <body>
    <header>
      <nav class="index-nav">
          <div class="navbar">
              <a href="index.php" class="hidden-xs"><img class="logo" alt="Graphic Shark Logo" src="img/navbar-Logo.png"></a>
              <button type="button" class="navbar-toggle || collapsed || visible-xs" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
                 <img class="logo" alt="Graphic Shark Logo" src="img/navbar-Logo.png">
             </button>
            <div class="triangle"></div>
          </div>
          <div id="navbar" class="navbar-collapse || visible-xs || collapse" aria-expanded="false" style="height: 1px;">
      ...
      <svg version="1.1" id="GS_Medal" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1467 317" style="enable-background:new 0 0 1467 317;" xml:space="preserve">
        <style type="text/css">
          .st0{fill:none;stroke:#D0DABC;stroke-width:2;stroke-miterlimit:10;}
          .st1{fill:#D0DABC;}
          .st2{fill:none;stroke:#D0DABC;stroke-miterlimit:10;}
          .st3{fill:none;stroke:#D0DABC;stroke-width:2;stroke-miterlimit:10;stroke-dasharray:7.9183,7.9183;}
        </style>
          ...
          <div class="col-xs-12 || col-sm-12 || col-md-12">
            ...
            <script type="text/ng-template" id="myModalContent.html">
              <div class="modal-header">
                  <h3 class="modal-title" id="modal-title">Headline 01</h3>
                  <button class="btn btn-warning" type="button" ng-click="$ctrl.cancel()">Cancel</button>
              </div>
              <div class="modal-body" id="modal-body">
                <img src="img/work/ranlife/ranlifeThumbnail.jpg">
              </div>
              <div class="modal-footer">
              </div>
          </script>

            <div  ng-controller="ModalDemoCtrl as $ctrl" ng-cloak>
              <div class="col-xs-12 || col-sm-4 || col-md-3" ng-repeat="work in $ctrl.works">
                <a href="" class="work-item" ng-click="$ctrl.open('lg', work)">
                  <div class="frame">
                    <img class="img-responsive" src="{{work.img}}" alt="">
                  </div>
                  <h3>{{work.header}}</h3>
                  <p>{{work.body}}</p>
                </a>
